...
data = pd.read_csv('ORCL.csv',date_parser=True)
...
regression = tensorflow.keras.models.load_model("GOOG-TanH-2nd.model")
...
plt.title('Google stock prediction with 2nd  model')
plt.xlabel('Time')
